...
/******/ (() => {
  ...
  /******/ var __webpack_modules__ = [
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class GenericExternalServices extends _app.DefaultExternalServices {
        ...
        static createL10n(_ref) {
          let { locale = "en-US" } = _ref;
          return new _genericl10n.GenericL10n(locale);
        }
        static createScripting(_ref2) {
          let { sandboxBundleSrc } = _ref2;
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const PDFViewerApplication = {
          ...
          try {
            ...
            for (let i = 0, ii = cssRules.length; i < ii; i++) {
              ...
              if (
                ...
                ((_rule$media = rule.media) === null || _rule$media === void 0
                  ? void 0
                  : _rule$media[0]) === "(prefers-color-scheme: dark)"
              ) {
            ...
            console.error(
              `_forceCssTheme: "${reason === null || reason === void 0 ? void 0 : reason.message}".`,
            );
          }
        },
        async _initializeViewerComponents() {
          var _appConfig$sidebar,
            _appConfig$secondaryT,
            _appConfig$secondaryT2,
            _appConfig$sidebar2,
            _appConfig$sidebar3,
            _appConfig$sidebar4;
          ...
          const pdfViewer = new _pdf_viewer.PDFViewer({
            ...
            isOffscreenCanvasSupported: _app_options.AppOptions.get(
          ...
          if (
            (_appConfig$sidebar = appConfig.sidebar) !== null &&
            _appConfig$sidebar !== void 0 &&
            _appConfig$sidebar.thumbnailView
          ) {
            this.pdfThumbnailViewer =
              new _webPdf_thumbnail_viewer.PDFThumbnailViewer({
          ...
          if (!this.supportsIntegratedFind && appConfig.findBar) {
            this.findBar = new _webPdf_find_bar.PDFFindBar(
              appConfig.findBar,
              eventBus,
              l10n,
            );
          ...
          if (appConfig.annotationEditorParams) {
            if (
              ...
              this.annotationEditorParams =
                new _webAnnotation_editor_params.AnnotationEditorParams(
              ...
              for (const id of ["editorModeButtons", "editorModeSeparator"]) {
                ...
                (_document$getElementB = document.getElementById(id)) ===
                  null || _document$getElementB === void 0
                  ? void 0
                  : _document$getElementB.classList.add("hidden");
              }
            }
          }
          if (appConfig.documentProperties) {
            this.pdfDocumentProperties =
              new _webPdf_document_properties.PDFDocumentProperties(
          ...
          if (
            (_appConfig$secondaryT = appConfig.secondaryToolbar) !== null &&
            _appConfig$secondaryT !== void 0 &&
            _appConfig$secondaryT.cursorHandToolButton
          ) {
          ...
          if (appConfig.toolbar) {
            this.toolbar = new _webToolbar.Toolbar(
              appConfig.toolbar,
              eventBus,
              l10n,
            );
          ...
          if (
            ...
            (_appConfig$secondaryT2 = appConfig.secondaryToolbar) !== null &&
            _appConfig$secondaryT2 !== void 0 &&
            _appConfig$secondaryT2.presentationModeButton
          ) {
            this.pdfPresentationMode =
              new _webPdf_presentation_mode.PDFPresentationMode({
                container,
                pdfViewer,
                eventBus,
              });
          ...
          if (
            (_appConfig$sidebar2 = appConfig.sidebar) !== null &&
            _appConfig$sidebar2 !== void 0 &&
            _appConfig$sidebar2.outlineView
          ) {
          ...
          if (
            (_appConfig$sidebar3 = appConfig.sidebar) !== null &&
            _appConfig$sidebar3 !== void 0 &&
            _appConfig$sidebar3.attachmentsView
          ) {
            this.pdfAttachmentViewer =
              new _webPdf_attachment_viewer.PDFAttachmentViewer({
          ...
          if (
            (_appConfig$sidebar4 = appConfig.sidebar) !== null &&
            _appConfig$sidebar4 !== void 0 &&
            _appConfig$sidebar4.layersView
          ) {
            ...
            this.pdfSidebar.onUpdateThumbnails = () => {
              for (const pageView of pdfViewer.getCachedPageViews()) {
                if (
                  ...
                  (_this$pdfThumbnailVie = this.pdfThumbnailViewer.getThumbnail(
                    pageView.id - 1,
                  )) === null || _this$pdfThumbnailVie === void 0
                    ? void 0
                    : _this$pdfThumbnailVie.setImage(pageView);
                }
              }
        ...
        _hideViewBookmark() {
          ...
          secondaryToolbar === null || secondaryToolbar === void 0
            ? void 0
            : secondaryToolbar.viewBookmarkButton.classList.add("hidden");
          if (
            secondaryToolbar !== null &&
            secondaryToolbar !== void 0 &&
            ...
            (_document$getElementB2 = document.getElementById(
              ...
              ? void 0
              : _document$getElementB2.classList.add("hidden");
          }
        },
        async close() {
          var _this$pdfDocument,
            _this$pdfSidebar,
            _this$pdfOutlineViewe,
            _this$pdfAttachmentVi,
            _this$pdfLayerViewer,
            _this$pdfHistory,
            _this$findBar,
            _this$toolbar,
          ...
          if (
            ((_this$pdfDocument = this.pdfDocument) === null ||
            _this$pdfDocument === void 0
              ? void 0
              : _this$pdfDocument.annotationStorage.size) > 0 &&
          ...
          if (this.pdfDocument) {
            ...
            (_this$pdfThumbnailVie2 = this.pdfThumbnailViewer) === null ||
            _this$pdfThumbnailVie2 === void 0
              ? void 0
              : _this$pdfThumbnailVie2.setDocument(null);
            this.pdfViewer.setDocument(null);
            this.pdfLinkService.setDocument(null);
            (_this$pdfDocumentProp = this.pdfDocumentProperties) === null ||
            _this$pdfDocumentProp === void 0
              ? void 0
              : _this$pdfDocumentProp.setDocument(null);
          }
          ...
          this.setTitle();
          (_this$pdfSidebar = this.pdfSidebar) === null ||
          _this$pdfSidebar === void 0
            ? void 0
            : _this$pdfSidebar.reset();
          (_this$pdfOutlineViewe = this.pdfOutlineViewer) === null ||
          _this$pdfOutlineViewe === void 0
            ? void 0
            : _this$pdfOutlineViewe.reset();
          (_this$pdfAttachmentVi = this.pdfAttachmentViewer) === null ||
          _this$pdfAttachmentVi === void 0
            ? void 0
            : _this$pdfAttachmentVi.reset();
          (_this$pdfLayerViewer = this.pdfLayerViewer) === null ||
          _this$pdfLayerViewer === void 0
            ? void 0
            : _this$pdfLayerViewer.reset();
          (_this$pdfHistory = this.pdfHistory) === null ||
          _this$pdfHistory === void 0
            ? void 0
            : _this$pdfHistory.reset();
          (_this$findBar = this.findBar) === null || _this$findBar === void 0
            ? void 0
            : _this$findBar.reset();
          (_this$toolbar = this.toolbar) === null || _this$toolbar === void 0
            ? void 0
            : _this$toolbar.reset();
          (_this$secondaryToolba = this.secondaryToolbar) === null ||
          _this$secondaryToolba === void 0
            ? void 0
            : _this$secondaryToolba.reset();
          (_this$_PDFBug = this._PDFBug) === null || _this$_PDFBug === void 0
            ? void 0
            : _this$_PDFBug.cleanup();
        ...
        async open(args) {
          ...
          const workerParams = _app_options.AppOptions.getAll(
          ...
          const apiParams = _app_options.AppOptions.getAll(
        ...
        downloadOrSave() {
          ...
          let options =
            arguments.length > 0 && arguments[0] !== undefined
              ...
              : {};
          if (
            ((_this$pdfDocument2 = this.pdfDocument) === null ||
            _this$pdfDocument2 === void 0
              ? void 0
              : _this$pdfDocument2.annotationStorage.size) > 0
          ) {
            this.save(options);
          } else {
        ...
        _documentError(message) {
          ...
          this.eventBus.dispatch("documenterror", {
            ...
            message,
            reason:
              (moreInfo === null || moreInfo === void 0
                ? void 0
                : moreInfo.message) ?? null,
          });
        },
        _otherError(message) {
          let moreInfo =
        ...
        progress(level) {
          ...
          if (
            ((_this$pdfDocument3 = this.pdfDocument) === null ||
            _this$pdfDocument3 === void 0
              ? void 0
              : _this$pdfDocument3.loadingParams.disableAutoFetch) ??
        ...
        load(pdfDocument) {
          var _this$toolbar2,
            _this$secondaryToolba2,
            _this$pdfDocumentProp2,
            _this$pdfThumbnailVie3;
          ...
          pdfDocument.getDownloadInfo().then((_ref2) => {
            ...
            (_this$loadingBar = this.loadingBar) === null ||
            _this$loadingBar === void 0
              ? void 0
              : _this$loadingBar.hide();
          ...
          const openActionPromise = pdfDocument
            .getOpenAction()
            .catch(function () {});
          (_this$toolbar2 = this.toolbar) === null || _this$toolbar2 === void 0
            ? void 0
            : _this$toolbar2.setPagesCount(pdfDocument.numPages, false);
          (_this$secondaryToolba2 = this.secondaryToolbar) === null ||
          _this$secondaryToolba2 === void 0
            ? void 0
            : _this$secondaryToolba2.setPagesCount(pdfDocument.numPages);
          this.pdfLinkService.setDocument(pdfDocument);
          (_this$pdfDocumentProp2 = this.pdfDocumentProperties) === null ||
          _this$pdfDocumentProp2 === void 0
            ? void 0
            : _this$pdfDocumentProp2.setDocument(pdfDocument);
          const pdfViewer = this.pdfViewer;
          pdfViewer.setDocument(pdfDocument);
          const { firstPagePromise, onePageRendered, pagesPromise } = pdfViewer;
          (_this$pdfThumbnailVie3 = this.pdfThumbnailViewer) === null ||
          _this$pdfThumbnailVie3 === void 0
            ? void 0
            : _this$pdfThumbnailVie3.setDocument(pdfDocument);
          ...
          firstPagePromise.then((pdfPage) => {
            ...
            (_this$loadingBar2 = this.loadingBar) === null ||
            _this$loadingBar2 === void 0
              ? void 0
              : _this$loadingBar2.setWidth(this.appConfig.viewerContainer);
            ...
            Promise.all([
              ...
              .then(async (_ref3) => {
                let [timeStamp, stored, pageLayout, pageMode, openAction] =
                  _ref3;
                ...
                this._initializePdfHistory({
                  ...
                  viewOnLoad,
                  initialDest:
                    openAction === null || openAction === void 0
                      ? void 0
                      : openAction.dest,
                });
        ...
        async _scriptingDocProperties(pdfDocument) {
          ...
          return {
            ...
            filename: this._docFilename,
            metadata:
              (_this$metadata = this.metadata) === null ||
              _this$metadata === void 0
                ? void 0
                : _this$metadata.getRaw(),
            authors:
              (_this$metadata2 = this.metadata) === null ||
              _this$metadata2 === void 0
                ? void 0
                : _this$metadata2.get("dc:creator"),
        ...
        async _initializePageLabels(pdfDocument) {
          ...
          pdfThumbnailViewer === null || pdfThumbnailViewer === void 0
            ? void 0
            : pdfThumbnailViewer.setPageLabels(labels);
          toolbar === null || toolbar === void 0
            ? void 0
        ...
        _initializePdfHistory(_ref4) {
          let { fingerprint, viewOnLoad, initialDest = null } = _ref4;
          if (!this.pdfHistory) {
            return;
          }
        ...
        setInitialView(storedHash) {
          ...
          let { rotation, sidebarView, scrollMode, spreadMode } =
            arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1]
              : {};
          ...
          (_this$pdfSidebar2 = this.pdfSidebar) === null ||
          _this$pdfSidebar2 === void 0
            ? void 0
            : _this$pdfSidebar2.setInitialView(sidebarView);
          ...
          (_this$toolbar3 = this.toolbar) === null || _this$toolbar3 === void 0
            ? void 0
            : _this$toolbar3.setPageNumber(
                this.pdfViewer.currentPageNumber,
                this.pdfViewer.currentPageLabel,
              );
          (_this$secondaryToolba3 = this.secondaryToolbar) === null ||
          _this$secondaryToolba3 === void 0
            ? void 0
            : _this$secondaryToolba3.setPageNumber(
                this.pdfViewer.currentPageNumber,
              );
        ...
        _cleanup() {
          ...
          (_this$pdfThumbnailVie4 = this.pdfThumbnailViewer) === null ||
          _this$pdfThumbnailVie4 === void 0
            ? void 0
            : _this$pdfThumbnailVie4.cleanup();
        ...
        forceRendering() {
          ...
          this.pdfRenderingQueue.isThumbnailViewEnabled =
            ((_this$pdfSidebar3 = this.pdfSidebar) === null ||
            _this$pdfSidebar3 === void 0
              ? void 0
              : _this$pdfSidebar3.visibleView) === _ui_utils.SidebarView.THUMBS;
        ...
        beforePrint() {
          this._printAnnotationStoragePromise = this.pdfScriptingManager
            ...
            .then(() => {
              ...
              return (_this$pdfDocument4 = this.pdfDocument) === null ||
                _this$pdfDocument4 === void 0
                ? void 0
                : _this$pdfDocument4.annotationStorage.print;
            });
        ...
        afterPrint() {
          ...
          if (this.printService) {
            ...
            (_this$pdfDocument5 = this.pdfDocument) === null ||
            _this$pdfDocument5 === void 0
              ? void 0
              : _this$pdfDocument5.annotationStorage.resetModified();
          }
          this.forceRendering();
          this.setTitle();
        },
        ...
        requestPresentationMode() {
          ...
          (_this$pdfPresentation = this.pdfPresentationMode) === null ||
          _this$pdfPresentation === void 0
            ? void 0
            : _this$pdfPresentation.request();
        },
        triggerPrinting() {
          if (!this.supportsPrinting) {
            return;
        ...
        unbindWindowEvents() {
          ...
          (_boundEvents$removeWi =
            _boundEvents.removeWindowResolutionChange) === null ||
          _boundEvents$removeWi === void 0
            ? void 0
            : _boundEvents$removeWi.call(_boundEvents);
        ...
        _unblockDocumentLoadEvent() {
          ...
          (_document$blockUnbloc = (_document = document)
            .blockUnblockOnload) === null || _document$blockUnbloc === void 0
            ? void 0
            : _document$blockUnbloc.call(_document, false);
          this._unblockDocumentLoadEvent = () => {};
        },
        get scriptingReady() {
      ...
      function reportPageStatsPDFBug(_ref5) {
        ...
        let { pageNumber } = _ref5;
        if (
          !(
            (_globalThis$Stats = globalThis.Stats) !== null &&
            _globalThis$Stats !== void 0 &&
            _globalThis$Stats.enabled
          )
        ) {
          return;
        }
        ...
        globalThis.Stats.add(
          pageNumber,
          pageView === null || pageView === void 0
            ? void 0
            : (_pageView$pdfPage = pageView.pdfPage) === null ||
                _pageView$pdfPage === void 0
              ? void 0
              : _pageView$pdfPage.stats,
        );
      }
      function webViewerInitialized() {
        ...
        if (!PDFViewerApplication.supportsPrinting) {
          ...
          (_appConfig$toolbar = appConfig.toolbar) === null ||
          _appConfig$toolbar === void 0
            ? void 0
            : (_appConfig$toolbar$pr = _appConfig$toolbar.print) === null ||
                _appConfig$toolbar$pr === void 0
              ? void 0
              : _appConfig$toolbar$pr.classList.add("hidden");
          (_appConfig$secondaryT3 = appConfig.secondaryToolbar) === null ||
          _appConfig$secondaryT3 === void 0
            ? void 0
            : _appConfig$secondaryT3.printButton.classList.add("hidden");
        }
        if (!PDFViewerApplication.supportsFullscreen) {
          var _appConfig$secondaryT4;
          (_appConfig$secondaryT4 = appConfig.secondaryToolbar) === null ||
          _appConfig$secondaryT4 === void 0
            ? void 0
            : _appConfig$secondaryT4.presentationModeButton.classList.add(
                "hidden",
              );
        }
        if (PDFViewerApplication.supportsIntegratedFind) {
          var _appConfig$toolbar2, _appConfig$toolbar2$v;
          (_appConfig$toolbar2 = appConfig.toolbar) === null ||
          _appConfig$toolbar2 === void 0
            ? void 0
            : (_appConfig$toolbar2$v = _appConfig$toolbar2.viewFind) === null ||
                _appConfig$toolbar2$v === void 0
              ? void 0
              : _appConfig$toolbar2$v.classList.add("hidden");
        }
      ...
      function webViewerPageRender(_ref6) {
        let { pageNumber } = _ref6;
        if (pageNumber === PDFViewerApplication.page) {
          var _PDFViewerApplication;
          (_PDFViewerApplication = PDFViewerApplication.toolbar) === null ||
          _PDFViewerApplication === void 0
            ? void 0
            : _PDFViewerApplication.updateLoadingIndicatorState(true);
        }
      }
      function webViewerPageRendered(_ref7) {
        var _PDFViewerApplication3;
        let { pageNumber, error } = _ref7;
        if (pageNumber === PDFViewerApplication.page) {
          var _PDFViewerApplication2;
          (_PDFViewerApplication2 = PDFViewerApplication.toolbar) === null ||
          _PDFViewerApplication2 === void 0
            ? void 0
            : _PDFViewerApplication2.updateLoadingIndicatorState(false);
        }
        if (
          ((_PDFViewerApplication3 = PDFViewerApplication.pdfSidebar) ===
            null || _PDFViewerApplication3 === void 0
            ? void 0
            : _PDFViewerApplication3.visibleView) ===
          ...
          const thumbnailView =
            (_PDFViewerApplication4 =
              PDFViewerApplication.pdfThumbnailViewer) === null ||
            _PDFViewerApplication4 === void 0
              ? void 0
              : _PDFViewerApplication4.getThumbnail(pageNumber - 1);
          if (pageView) {
            thumbnailView === null || thumbnailView === void 0
              ? void 0
      ...
      function webViewerPageMode(_ref8) {
        ...
        (_PDFViewerApplication5 = PDFViewerApplication.pdfSidebar) === null ||
        _PDFViewerApplication5 === void 0
          ? void 0
          : _PDFViewerApplication5.switchView(view, true);
      }
      function webViewerNamedAction(evt) {
        var _PDFViewerApplication6;
        switch (evt.action) {
          case "GoToPage":
            (_PDFViewerApplication6 =
              PDFViewerApplication.appConfig.toolbar) === null ||
            _PDFViewerApplication6 === void 0
              ? void 0
              : _PDFViewerApplication6.pageNumber.select();
            break;
          case "Find":
            if (!PDFViewerApplication.supportsIntegratedFind) {
              PDFViewerApplication === null || PDFViewerApplication === void 0
                ? void 0
      ...
      function webViewerSidebarViewChanged(_ref9) {
        ...
        if (PDFViewerApplication.isInitialViewSet) {
          ...
          (_PDFViewerApplication7 = PDFViewerApplication.store) === null ||
          _PDFViewerApplication7 === void 0
            ? void 0
            : _PDFViewerApplication7.set("sidebarView", view).catch(() => {});
        }
      }
      function webViewerUpdateViewarea(_ref10) {
        ...
        if (PDFViewerApplication.isInitialViewSet) {
          ...
          (_PDFViewerApplication8 = PDFViewerApplication.store) === null ||
          _PDFViewerApplication8 === void 0
            ? void 0
            : _PDFViewerApplication8
                .setMultiple({
      ...
      function webViewerScrollModeChanged(evt) {
        if (
          ...
          (_PDFViewerApplication9 = PDFViewerApplication.store) === null ||
          _PDFViewerApplication9 === void 0
            ? void 0
            : _PDFViewerApplication9
      ...
      function webViewerSpreadModeChanged(evt) {
        if (
          ...
          (_PDFViewerApplication10 = PDFViewerApplication.store) === null ||
          _PDFViewerApplication10 === void 0
            ? void 0
            : _PDFViewerApplication10
      ...
      function webViewerHashchange(evt) {
        ...
        if (!PDFViewerApplication.isInitialViewSet) {
          ...
          !(
            (_PDFViewerApplication11 = PDFViewerApplication.pdfHistory) !==
              null &&
            _PDFViewerApplication11 !== void 0 &&
            _PDFViewerApplication11.popStateInProgress
          )
        ) {
      ...
      }
      {
        var webViewerFileInputChange = function (evt) {
          ...
          if (
            (_PDFViewerApplication12 = PDFViewerApplication.pdfViewer) !==
              null &&
            _PDFViewerApplication12 !== void 0 &&
            _PDFViewerApplication12.isInPresentationMode
          ) {
            return;
          }
      ...
      function webViewerPageNumberChanged(evt) {
        ...
        if (
          ...
          (_PDFViewerApplication13 = PDFViewerApplication.toolbar) === null ||
          _PDFViewerApplication13 === void 0
            ? void 0
            : _PDFViewerApplication13.setPageNumber(
                pdfViewer.currentPageNumber,
                pdfViewer.currentPageLabel,
              );
        }
      ...
      function webViewerDocumentProperties() {
        ...
        (_PDFViewerApplication14 =
          PDFViewerApplication.pdfDocumentProperties) === null ||
        _PDFViewerApplication14 === void 0
          ? void 0
          : _PDFViewerApplication14.open();
      }
      ...
      function webViewerUpdateFindControlState(_ref12) {
        let { state, previous, matchesCount, rawQuery } = _ref12;
        if (PDFViewerApplication.supportsIntegratedFind) {
          ...
          (_PDFViewerApplication15 = PDFViewerApplication.findBar) === null ||
          _PDFViewerApplication15 === void 0
            ? void 0
            : _PDFViewerApplication15.updateUIState(
                state,
                previous,
                matchesCount,
              );
      ...
      function webViewerScaleChanging(evt) {
        ...
        (_PDFViewerApplication16 = PDFViewerApplication.toolbar) === null ||
        _PDFViewerApplication16 === void 0
          ? void 0
          : _PDFViewerApplication16.setPageScale(evt.presetValue, evt.scale);
      ...
      function webViewerPageChanging(_ref13) {
        var _PDFViewerApplication17,
          _PDFViewerApplication18,
          _PDFViewerApplication19,
          _PDFViewerApplication21;
        let { pageNumber, pageLabel } = _ref13;
        (_PDFViewerApplication17 = PDFViewerApplication.toolbar) === null ||
        _PDFViewerApplication17 === void 0
          ? void 0
          : _PDFViewerApplication17.setPageNumber(pageNumber, pageLabel);
        (_PDFViewerApplication18 = PDFViewerApplication.secondaryToolbar) ===
          null || _PDFViewerApplication18 === void 0
          ? void 0
          : _PDFViewerApplication18.setPageNumber(pageNumber);
        if (
          ((_PDFViewerApplication19 = PDFViewerApplication.pdfSidebar) ===
            null || _PDFViewerApplication19 === void 0
            ? void 0
            : _PDFViewerApplication19.visibleView) ===
          _ui_utils.SidebarView.THUMBS
        ) {
          var _PDFViewerApplication20;
          (_PDFViewerApplication20 =
            PDFViewerApplication.pdfThumbnailViewer) === null ||
          _PDFViewerApplication20 === void 0
            ? void 0
            : _PDFViewerApplication20.scrollThumbnailIntoView(pageNumber);
        }
        const currentPage = PDFViewerApplication.pdfViewer.getPageView(
          pageNumber - 1,
        );
        (_PDFViewerApplication21 = PDFViewerApplication.toolbar) === null ||
        _PDFViewerApplication21 === void 0
          ? void 0
          : _PDFViewerApplication21.updateLoadingIndicatorState(
              (currentPage === null || currentPage === void 0
                ? void 0
                : currentPage.renderingState) ===
                _ui_utils.RenderingStates.RUNNING,
            );
      }
      ...
      function webViewerTouchMove(evt) {
        ...
        const pDistance =
          Math.hypot(pTouch0X - pTouch1X, pTouch0Y - pTouch1Y) || 1;
        const previousScale = pdfViewer.currentScale;
      ...
      function webViewerClick(evt) {
        var _PDFViewerApplication22,
          _appConfig$toolbar3,
          _appConfig$secondaryT5;
        if (
          !(
            (_PDFViewerApplication22 =
              PDFViewerApplication.secondaryToolbar) !== null &&
            _PDFViewerApplication22 !== void 0 &&
            _PDFViewerApplication22.isOpen
          )
        ) {
          return;
        }
        ...
        if (
          ...
          ((_appConfig$toolbar3 = appConfig.toolbar) !== null &&
            _appConfig$toolbar3 !== void 0 &&
            _appConfig$toolbar3.container.contains(evt.target) &&
            evt.target !==
              ((_appConfig$secondaryT5 = appConfig.secondaryToolbar) === null ||
              _appConfig$secondaryT5 === void 0
                ? void 0
                : _appConfig$secondaryT5.toggleButton))
        ) {
      ...
      function webViewerKeyDown(evt) {
        var _PDFViewerApplication24,
          _PDFViewerApplication25,
          _PDFViewerApplication26,
          _PDFViewerApplication27,
          _PDFViewerApplication28;
          ...
          switch (evt.keyCode) {
            case 70:
              if (
                ...
                (_PDFViewerApplication23 = PDFViewerApplication.findBar) ===
                  null || _PDFViewerApplication23 === void 0
                  ? void 0
                  : _PDFViewerApplication23.open();
                handled = true;
              }
              break;
            case 71:
        ...
        const curElementTagName =
          curElement === null || curElement === void 0
            ? void 0
        ...
        if (cmd === 0) {
          ...
          switch (evt.keyCode) {
            ...
            case 27:
              if (
                (_PDFViewerApplication24 =
                  PDFViewerApplication.secondaryToolbar) !== null &&
                _PDFViewerApplication24 !== void 0 &&
                _PDFViewerApplication24.isOpen
              ) {
                PDFViewerApplication.secondaryToolbar.close();
                handled = true;
              }
              if (
                !PDFViewerApplication.supportsIntegratedFind &&
                (_PDFViewerApplication25 = PDFViewerApplication.findBar) !==
                  null &&
                _PDFViewerApplication25 !== void 0 &&
                _PDFViewerApplication25.opened
              ) {
            ...
            case 83:
              (_PDFViewerApplication26 =
                PDFViewerApplication.pdfCursorTools) === null ||
              _PDFViewerApplication26 === void 0
                ? void 0
                : _PDFViewerApplication26.switchTool(
                    _ui_utils.CursorTool.SELECT,
                  );
              break;
            case 72:
              (_PDFViewerApplication27 =
                PDFViewerApplication.pdfCursorTools) === null ||
              _PDFViewerApplication27 === void 0
                ? void 0
                : _PDFViewerApplication27.switchTool(_ui_utils.CursorTool.HAND);
              break;
            case 82:
              PDFViewerApplication.rotatePages(90);
              break;
            case 115:
              (_PDFViewerApplication28 = PDFViewerApplication.pdfSidebar) ===
                null || _PDFViewerApplication28 === void 0
                ? void 0
                : _PDFViewerApplication28.toggle();
              break;
          }
          if (
            turnPage !== 0 &&
    ...
    /***/ (__unused_webpack_module, exports) => {
      ...
      function getActiveOrFocusedElement() {
        ...
        while (
          (_curActiveOrFocused = curActiveOrFocused) !== null &&
          _curActiveOrFocused !== void 0 &&
          _curActiveOrFocused.shadowRoot
        ) {
        ...
        executeNamedAction(action) {
          ...
          switch (action) {
            case "GoBack":
              ...
              _this$pdfHistory === void 0
                ? void 0
                : _this$pdfHistory.back();
              break;
            case "GoForward":
              (_this$pdfHistory2 = this.pdfHistory) === null ||
              _this$pdfHistory2 === void 0
                ? void 0
                : _this$pdfHistory2.forward();
              break;
            case "NextPage":
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFAttachmentViewer extends _base_tree_viewer.BaseTreeViewer {
        ...
        render(_ref2) {
          let { attachments, keepRenderedCapability = false } = _ref2;
      ...
      class GrabToPan {
        ...
        activate() {
          if (!this.active) {
            ...
            (_this$onActiveChanged = this.onActiveChanged) === null ||
            _this$onActiveChanged === void 0
              ? void 0
              : _this$onActiveChanged.call(this, true);
          }
        }
        deactivate() {
          if (this.active) {
            ...
            (_this$onActiveChanged2 = this.onActiveChanged) === null ||
            _this$onActiveChanged2 === void 0
              ? void 0
              : _this$onActiveChanged2.call(this, false);
          }
        }
        toggle() {
          if (this.active) {
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFDocumentProperties {
        ...
        constructor(_ref, overlayManager, eventBus, l10n, fileNameLookup) {
          let { dialog, fields, closeButton } = _ref;
          this.dialog = dialog;
          this.fields = fields;
          this.overlayManager = overlayManager;
          this.l10n = l10n;
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      function normalize(text) {
        ...
        if (syllablePositions.length === 0 && noSyllablesRegExp) {
          ...
          _pdf_find_utils.getNormalizeWithNFKC)();
        ...
        normalized = normalized.replace(
          ...
          (match, p1, p2, p3, p4, p5, p6, p7, p8, i) => {
            ...
            if (p3) {
              ...
              if (
                i + eol ===
                ((_rawDiacriticsPositio =
                  rawDiacriticsPositions[rawDiacriticsIndex]) === null ||
                _rawDiacriticsPositio === void 0
                  ? void 0
                  : _rawDiacriticsPositio[1])
              ) {
                ++rawDiacriticsIndex;
              } else {
            ...
            if (p4) {
              ...
              if (
                i + eol ===
                ((_rawDiacriticsPositio2 =
                  rawDiacriticsPositions[rawDiacriticsIndex]) === null ||
                _rawDiacriticsPositio2 === void 0
                  ? void 0
                  : _rawDiacriticsPositio2[1])
              ) {
            ...
            if (
              i + eol ===
              ((_syllablePositions$sy = syllablePositions[syllableIndex]) ===
                null || _syllablePositions$sy === void 0
                ? void 0
                : _syllablePositions$sy[1])
            ) {
          ...
          switch (state.type) {
            case "again":
              ...
              return (
                ...
                !(
                  ((_this$onIsPageVisible = this.onIsPageVisible) === null ||
                  _this$onIsPageVisible === void 0
                    ? void 0
                    : _this$onIsPageVisible.call(this, pageNumber)) ?? true
                )
              );
        ...
        #requestMatchesCount() {
          ...
          if (matchIdx !== -1) {
            for (let i = 0; i < pageIdx; i++) {
              ...
              current +=
                ((_this$_pageMatches$i = this._pageMatches[i]) === null ||
                _this$_pageMatches$i === void 0
                  ? void 0
                  : _this$_pageMatches$i.length) || 0;
            }
            current += matchIdx + 1;
          }
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFHistory {
        ...
        initialize(_ref2) {
          let { fingerprint, resetHistory = false, updateUrl = false } = _ref2;
        ...
        push(_ref3) {
          let { namedDest = null, explicitDest, pageNumber } = _ref3;
          if (!this._initialized) {
            return;
          }
        ...
        pushPage(pageNumber) {
          ...
          if (
            ((_this$_destination = this._destination) === null ||
            _this$_destination === void 0
              ? void 0
              : _this$_destination.page) === pageNumber
          ) {
            return;
          }
          if (this._popStateInProgress) {
        ...
        _isValidState(state) {
          ...
          if (state.fingerprint !== this._fingerprint) {
            if (checkReload) {
              ...
              if (
                (perfEntry === null || perfEntry === void 0
                  ? void 0
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFLayerViewer extends _base_tree_viewer.BaseTreeViewer {
        ...
        render(_ref4) {
          let { optionalContentConfig, pdfDocument } = _ref4;
          if (this._optionalContentConfig) {
            this.reset();
          }
          ...
          const groups =
            optionalContentConfig === null || optionalContentConfig === void 0
              ? void 0
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFOutlineViewer extends _base_tree_viewer.BaseTreeViewer {
        ...
        _dispatchEvent(outlineCount) {
          ...
          this._currentOutlineItemCapability =
            new _pdfjsLib.PromiseCapability();
          if (
            outlineCount === 0 ||
            ((_this$_pdfDocument = this._pdfDocument) !== null &&
              _this$_pdfDocument !== void 0 &&
              _this$_pdfDocument.loadingParams.disableAutoFetch)
          ) {
            this._currentOutlineItemCapability.resolve(false);
        ...
        _bindLink(element, _ref) {
          let { url, newWindow, action, attachment, dest, setOCGState } = _ref;
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFPresentationMode {
        ...
        #args = null;
        constructor(_ref) {
          let { container, pdfViewer, eventBus } = _ref;
          this.container = container;
          this.pdfViewer = pdfViewer;
          this.eventBus = eventBus;
        ...
        #mouseDown(evt) {
          ...
          if (
            evt.target.href &&
            (_evt$target$parentNod = evt.target.parentNode) !== null &&
            _evt$target$parentNod !== void 0 &&
            _evt$target$parentNod.hasAttribute("data-internal-link")
          ) {
            return;
          }
          evt.preventDefault();
      ...
      class PDFRenderingQueue {
        ...
        renderHighestPriority(currentlyVisiblePages) {
          ...
          if (
            ...
            (_this$pdfThumbnailVie = this.pdfThumbnailViewer) !== null &&
            _this$pdfThumbnailVie !== void 0 &&
            _this$pdfThumbnailVie.forceRendering()
          ) {
            return;
          }
          if (this.printing) {
      ...
      class PDFScriptingManager {
        ...
        async setDocument(pdfDocument) {
          ...
          try {
            ...
            console.error(
              `PDFScriptingManager.setDocument: "${error === null || error === void 0 ? void 0 : error.message}".`,
            );
            await this._destroyScripting();
            return;
          }
          this._internalEvents.set("updatefromsandbox", (event) => {
            if (
              (event === null || event === void 0 ? void 0 : event.source) !==
              window
            ) {
              return;
            }
          ...
          this._internalEvents.set("dispatcheventinsandbox", (event) => {
            ...
            (_this$_scripting = this._scripting) === null ||
            _this$_scripting === void 0
              ? void 0
              : _this$_scripting.dispatchEventInSandbox(event.detail);
          });
          this._internalEvents.set("pagechanging", (_ref2) => {
            let { pageNumber, previous } = _ref2;
          ...
          this._internalEvents.set("pagesdestroy", async (event) => {
            ...
            await ((_this$_scripting2 = this._scripting) === null ||
            _this$_scripting2 === void 0
              ? void 0
              : _this$_scripting2.dispatchEventInSandbox({
                  id: "doc",
                  name: "WillClose",
                }));
            (_this$_closeCapabilit = this._closeCapability) === null ||
            _this$_closeCapabilit === void 0
              ? void 0
              : _this$_closeCapabilit.resolve();
          });
          ...
          await ((_this$_scripting3 = this._scripting) === null ||
          _this$_scripting3 === void 0
            ? void 0
        ...
        async dispatchWillSave(detail) {
          ...
          return (_this$_scripting4 = this._scripting) === null ||
            _this$_scripting4 === void 0
            ? void 0
        ...
        async dispatchDidSave(detail) {
          ...
          return (_this$_scripting5 = this._scripting) === null ||
            _this$_scripting5 === void 0
            ? void 0
        ...
        async dispatchWillPrint(detail) {
          ...
          return (_this$_scripting6 = this._scripting) === null ||
            _this$_scripting6 === void 0
            ? void 0
        ...
        async dispatchDidPrint(detail) {
          ...
          return (_this$_scripting7 = this._scripting) === null ||
            _this$_scripting7 === void 0
            ? void 0
        ...
        get destroyPromise() {
          ...
          return (
            ((_this$_destroyCapabil = this._destroyCapability) === null ||
            _this$_destroyCapabil === void 0
              ? void 0
              : _this$_destroyCapabil.promise) || null
          );
        }
        get ready() {
          return this._ready;
        ...
        async _updateFromSandbox(detail) {
          ...
          for (const elementId of ids) {
            ...
            if (element) {
              ...
              _this$_pdfDocument === void 0
                ? void 0
                : _this$_pdfDocument.annotationStorage.setValue(
                    elementId,
                    detail,
                  );
            }
          ...
          const actionsPromise = (async () => {
            ...
            const actions = await (!visitedPages.has(pageNumber)
              ? (_pageView$pdfPage = pageView.pdfPage) === null ||
                _pageView$pdfPage === void 0
                ? void 0
                : _pageView$pdfPage.getJSActions()
              : null);
            if (pdfDocument !== this._pdfDocument) {
              return;
            }
            await ((_this$_scripting8 = this._scripting) === null ||
            _this$_scripting8 === void 0
              ? void 0
        ...
        async _dispatchPageClose(pageNumber) {
          ...
          await ((_this$_scripting9 = this._scripting) === null ||
          _this$_scripting9 === void 0
            ? void 0
            : _this$_scripting9.dispatchEventInSandbox({
                id: "page",
                name: "PageClose",
                pageNumber,
              }));
        ...
        async _destroyScripting() {
          ...
          if (!this._scripting) {
            ...
            this._pdfDocument = null;
            (_this$_destroyCapabil2 = this._destroyCapability) === null ||
            _this$_destroyCapabil2 === void 0
              ? void 0
              : _this$_destroyCapabil2.resolve();
            return;
          }
          if (this._closeCapability) {
            await Promise.race([
          ...
          this._scripting = null;
          this._ready = false;
          (_this$_destroyCapabil3 = this._destroyCapability) === null ||
          _this$_destroyCapabil3 === void 0
            ? void 0
            : _this$_destroyCapabil3.resolve();
        }
      }
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFSidebar {
        ...
        #width = null;
        constructor(_ref) {
          let { elements, eventBus, l10n } = _ref;
          this.isOpen = false;
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFThumbnailViewer {
        ...
        setDocument(pdfDocument) {
          ...
          firstPagePromise
            .then((firstPdfPage) => {
              ...
              (_this$_thumbnails$ = this._thumbnails[0]) === null ||
              _this$_thumbnails$ === void 0
                ? void 0
                : _this$_thumbnails$.setPdfPage(firstPdfPage);
              const thumbnailView =
                this._thumbnails[this._currentPageNumber - 1];
              thumbnailView.div.classList.add(THUMBNAIL_SELECTED_CLASS);
            })
        ...
        setPageLabels(labels) {
          ...
          for (let i = 0, ii = this._thumbnails.length; i < ii; i++) {
            ...
            this._thumbnails[i].setPageLabel(
              ((_this$_pageLabels = this._pageLabels) === null ||
              _this$_pageLabels === void 0
                ? void 0
                : _this$_pageLabels[i]) ?? null,
            );
          }
        }
        ...
        #getScrollAhead(visible) {
          ...
          if (
            ((_visible$first = visible.first) === null ||
            _visible$first === void 0
              ? void 0
              : _visible$first.id) === 1
          ) {
            return true;
          } else if (
            ((_visible$last = visible.last) === null || _visible$last === void 0
              ? void 0
              : _visible$last.id) === this._thumbnails.length
          ) {
            return false;
          }
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFThumbnailView {
        ...
        reset() {
          ...
          (_this$image = this.image) === null || _this$image === void 0
            ? void 0
            : _this$image.replaceWith(this._placeholderImg);
          this.#updateDims();
          if (this.image) {
        ...
        setPageLabel(label) {
          ...
          this._thumbPageCanvas.then((msg) => {
            var _this$image2;
            (_this$image2 = this.image) === null || _this$image2 === void 0
              ? void 0
              : _this$image2.setAttribute("aria-label", msg);
          });
        }
      }
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFPageViewBuffer {
        ...
        #destroyFirstView() {
          ...
          firstView === null || firstView === void 0
            ? void 0
            : firstView.destroy();
      ...
      class PDFViewer {
        ...
        constructor(options) {
          ...
          if (
            ...
            _this$container === void 0
              ? void 0
              : _this$container.tagName) !== "DIV" ||
            ((_this$viewer = this.viewer) === null || _this$viewer === void 0
              ? void 0
              : _this$viewer.tagName) !== "DIV"
          ) {
          ...
          this.eventBus._on("thumbnailrendered", (_ref) => {
            let { pageNumber, pdfPage } = _ref;
            const pageView = this._pages[pageNumber - 1];
            if (!this.#buffer.has(pageView)) {
              pdfPage === null || pdfPage === void 0
                ? void 0
                : pdfPage.cleanup();
            }
          });
        ...
        get currentPageLabel() {
          ...
          return (
            ((_this$_pageLabels2 = this._pageLabels) === null ||
            _this$_pageLabels2 === void 0
              ? void 0
              : _this$_pageLabels2[this._currentPageNumber - 1]) ?? null
          );
        }
        ...
        #layerProperties() {
          ...
          return {
            ...
            get annotationStorage() {
              ...
              return (_self$pdfDocument = self.pdfDocument) === null ||
                _self$pdfDocument === void 0
                ? void 0
                : _self$pdfDocument.annotationStorage;
            },
            get downloadManager() {
            ...
            get fieldObjectsPromise() {
              ...
              return (_self$pdfDocument2 = self.pdfDocument) === null ||
                _self$pdfDocument2 === void 0
                ? void 0
                : _self$pdfDocument2.getFieldObjects();
            },
            get findController() {
            ...
            get hasJSActionsPromise() {
              ...
              return (_self$pdfDocument3 = self.pdfDocument) === null ||
                _self$pdfDocument3 === void 0
                ? void 0
                : _self$pdfDocument3.hasJSActions();
            },
            get linkService() {
        ...
        setDocument(pdfDocument) {
          if (this.pdfDocument) {
            ...
            this._cancelRendering();
            this._resetView();
            (_this$findController = this.findController) === null ||
            _this$findController === void 0
              ? void 0
              : _this$findController.setDocument(null);
            (_this$_scriptingManag = this._scriptingManager) === null ||
            _this$_scriptingManag === void 0
              ? void 0
              : _this$_scriptingManag.setDocument(null);
          ...
          Promise.all([firstPagePromise, permissionsPromise])
            .then((_ref2) => {
                ...
                if (pdfDocument.isPureXfa) {
                  ...
                  this.#annotationEditorUIManager =
                    new _pdfjsLib.AnnotationEditorUIManager(
                      this.container,
                      this.eventBus,
                      pdfDocument === null || pdfDocument === void 0
                        ? void 0
              ...
              this.#onePageRenderedOrForceFetch().then(async () => {
                ...
                _this$findController2 === void 0
                  ? void 0
                  : _this$findController2.setDocument(pdfDocument);
                (_this$_scriptingManag2 = this._scriptingManager) === null ||
                _this$_scriptingManag2 === void 0
                  ? void 0
                  : _this$_scriptingManag2.setDocument(pdfDocument);
        ...
        setPageLabels(labels) {
          ...
          for (let i = 0, ii = this._pages.length; i < ii; i++) {
            ...
            this._pages[i].setPageLabel(
              ((_this$_pageLabels3 = this._pageLabels) === null ||
              _this$_pageLabels3 === void 0
                ? void 0
                : _this$_pageLabels3[i]) ?? null,
            );
          }
        }
        _resetView() {
        ...
        #setScaleUpdatePages(newScale, newValue, _ref4) {
          let { noScroll = false, preset = false, drawingDelay = -1 } = _ref4;
        ...
        async #ensurePdfPageLoaded(pageView) {
          ...
          try {
            ...
            if (
              !(
                (_this$linkService$_ca = (_this$linkService = this.linkService)
                  ._cachedPageNumber) !== null &&
                _this$linkService$_ca !== void 0 &&
                _this$linkService$_ca.call(_this$linkService, pdfPage.ref)
              )
            ) {
        ...
        #getScrollAhead(visible) {
          ...
          if (
            ...
            ((_visible$last = visible.last) === null || _visible$last === void 0
              ? void 0
              : _visible$last.id) === this.pagesCount
          ) {
            return false;
          }
        ...
        increaseScale() {
          let { drawingDelay, scaleFactor, steps } =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : {};
          if (!this.pdfDocument) {
          ...
          if (scaleFactor > 1) {
            ...
            do {
              newScale =
                Math.ceil(
                  (newScale * _ui_utils.DEFAULT_SCALE_DELTA).toFixed(2) * 10,
                ) / 10;
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFPageView {
        ...
        constructor(options) {
          ...
          this.resume = null;
          this._isStandalone = !(
            (_this$renderingQueue = this.renderingQueue) !== null &&
            _this$renderingQueue !== void 0 &&
            _this$renderingQueue.hasViewer()
          );
        ...
        destroy() {
          var _this$pdfPage;
          this.reset();
          (_this$pdfPage = this.pdfPage) === null || _this$pdfPage === void 0
            ? void 0
            : _this$pdfPage.cleanup();
        }
        ...
        async #renderStructTreeLayer() {
          ...
          this.structTreeLayer ||=
            new _struct_tree_layer_builder.StructTreeLayerBuilder();
          const tree = await (!this.structTreeLayer.renderingDone
            ? this.pdfPage.getStructTree()
            : null);
          const treeDom =
            (_this$structTreeLayer = this.structTreeLayer) === null ||
            _this$structTreeLayer === void 0
              ? void 0
              : _this$structTreeLayer.render(tree);
          if (treeDom) {
            var _this$canvas;
            (_this$canvas = this.canvas) === null || _this$canvas === void 0
              ? void 0
              : _this$canvas.append(treeDom);
          }
          (_this$structTreeLayer2 = this.structTreeLayer) === null ||
          _this$structTreeLayer2 === void 0
            ? void 0
            : _this$structTreeLayer2.show();
        }
        ...
        reset() {
          var _this$annotationLayer,
            _this$annotationEdito,
            _this$xfaLayer,
            _this$textLayer,
            _this$structTreeLayer3;
          let {
            keepZoomLayer = false,
          ...
          const childNodes = div.childNodes,
            ...
            annotationLayerNode =
              (keepAnnotationLayer &&
                ((_this$annotationLayer = this.annotationLayer) === null ||
                _this$annotationLayer === void 0
                  ? void 0
                  : _this$annotationLayer.div)) ||
              null,
            annotationEditorLayerNode =
              (keepAnnotationEditorLayer &&
                ((_this$annotationEdito = this.annotationEditorLayer) ===
                  null || _this$annotationEdito === void 0
                  ? void 0
                  : _this$annotationEdito.div)) ||
              null,
            xfaLayerNode =
              (keepXfaLayer &&
                ((_this$xfaLayer = this.xfaLayer) === null ||
                _this$xfaLayer === void 0
                  ? void 0
                  : _this$xfaLayer.div)) ||
              null,
            textLayerNode =
              (keepTextLayer &&
                ((_this$textLayer = this.textLayer) === null ||
                _this$textLayer === void 0
                  ? void 0
                  : _this$textLayer.div)) ||
              null;
          ...
          (_this$structTreeLayer3 = this.structTreeLayer) === null ||
          _this$structTreeLayer3 === void 0
            ? void 0
            : _this$structTreeLayer3.hide();
          if (!zoomLayerNode) {
            if (this.canvas) {
        ...
        update(_ref) {
          ...
          if (this._isStandalone) {
            ...
            (_this$div$parentNode = this.div.parentNode) === null ||
            _this$div$parentNode === void 0
              ? void 0
              : _this$div$parentNode.style.setProperty(
                  "--scale-factor",
                  this.viewport.scale,
                );
          }
        ...
        cancelRendering() {
          ...
          if (this.xfaLayer && (!keepXfaLayer || !this.xfaLayer.div)) {
            ...
            this.xfaLayer = null;
            (_this$_textHighlighte = this._textHighlighter) === null ||
            _this$_textHighlighte === void 0
              ? void 0
              : _this$_textHighlighte.disable();
          }
        }
        cssTransform(_ref2) {
          let {
          ...
          if (this.textLayer) {
            if (hideTextLayer) {
              ...
              this.textLayer.hide();
              (_this$structTreeLayer4 = this.structTreeLayer) === null ||
              _this$structTreeLayer4 === void 0
                ? void 0
                : _this$structTreeLayer4.hide();
        ...
        async draw() {
          ...
          if (
            ...
            this.textLayer = new _text_layer_builder.TextLayerBuilder({
              ...
              enablePermissions:
                this.#textLayerMode ===
                _ui_utils.TextLayerMode.ENABLE_PERMISSIONS,
            });
          ...
          if (
            ...
            this.annotationLayer =
              new _annotation_layer_builder.AnnotationLayerBuilder({
                pageDiv: div,
                pdfPage,
                annotationStorage,
                imageResourcesPath: this.imageResourcesPath,
          ...
          const renderContinueCallback = (cont) => {
            var _showCanvas;
            (_showCanvas = showCanvas) === null || _showCanvas === void 0
              ? void 0
              : _showCanvas(false);
            if (
              this.renderingQueue &&
          ...
          const resultPromise = renderTask.promise.then(
            async () => {
              var _showCanvas2;
              (_showCanvas2 = showCanvas) === null || _showCanvas2 === void 0
                ? void 0
                : _showCanvas2(true);
            ...
            (error) => {
              if (!(error instanceof _pdfjsLib.RenderingCancelledException)) {
                var _showCanvas3;
                (_showCanvas3 = showCanvas) === null || _showCanvas3 === void 0
                  ? void 0
                  : _showCanvas3(true);
              }
      ...
      class AnnotationLayerBuilder {
        ...
        async render(viewport) {
          ...
          if (!this.#onPresentationModeChanged) {
            ...
            (_this$_eventBus = this._eventBus) === null ||
            _this$_eventBus === void 0
              ? void 0
              : _this$_eventBus._on(
                  "presentationmodechanged",
        ...
        cancel() {
          ...
          if (this.#onPresentationModeChanged) {
            ...
            (_this$_eventBus2 = this._eventBus) === null ||
            _this$_eventBus2 === void 0
              ? void 0
              : _this$_eventBus2._off(
                  "presentationmodechanged",
                  this.#onPresentationModeChanged,
                );
    ...
    /***/ (__unused_webpack_module, exports) => {
      ...
      class StructTreeLayerBuilder {
        ...
        show() {
          var _this$treeDom;
          if (
            (_this$treeDom = this.#treeDom) !== null &&
            _this$treeDom !== void 0 &&
            _this$treeDom.hidden
          ) {
    ...
    /***/ (__unused_webpack_module, exports) => {
      ...
      class TextHighlighter {
        constructor(_ref) {
          let { findController, eventBus, pageIndex } = _ref;
          this.findController = findController;
          this.matches = [];
          this.eventBus = eventBus;
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class TextLayerBuilder {
        ...
        async render(viewport) {
          ...
          this.cancel();
          (_this$highlighter = this.highlighter) === null ||
          _this$highlighter === void 0
            ? void 0
            : _this$highlighter.setTextMapping(
                this.textDivs,
                this.textContentItemsStr,
              );
          (_this$accessibilityMa = this.accessibilityManager) === null ||
          _this$accessibilityMa === void 0
            ? void 0
            : _this$accessibilityMa.setTextMapping(this.textDivs);
          ...
          this.#rotation = rotation;
          this.show();
          (_this$accessibilityMa2 = this.accessibilityManager) === null ||
          _this$accessibilityMa2 === void 0
            ? void 0
            : _this$accessibilityMa2.enable();
        }
        hide() {
          if (!this.div.hidden) {
            var _this$highlighter2;
            (_this$highlighter2 = this.highlighter) === null ||
            _this$highlighter2 === void 0
              ? void 0
              : _this$highlighter2.disable();
            this.div.hidden = true;
          }
        }
        show() {
          if (this.div.hidden && this.renderingDone) {
            ...
            this.div.hidden = false;
            (_this$highlighter3 = this.highlighter) === null ||
            _this$highlighter3 === void 0
              ? void 0
              : _this$highlighter3.enable();
          }
        }
        cancel() {
          ...
          (_this$highlighter4 = this.highlighter) === null ||
          _this$highlighter4 === void 0
            ? void 0
            : _this$highlighter4.disable();
          (_this$accessibilityMa3 = this.accessibilityManager) === null ||
          _this$accessibilityMa3 === void 0
            ? void 0
            : _this$accessibilityMa3.disable();
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class SecondaryToolbar {
        ...
        #bindCursorToolsListener(_ref) {
          let { cursorSelectToolButton, cursorHandToolButton } = _ref;
        ...
        #bindSpreadModeListener(_ref5) {
          let { spreadNoneButton, spreadOddButton, spreadEvenButton } = _ref5;
          ...
          this.#initializedPromise = this._readFromStorage(this.#defaults).then(
            (prefs) => {
              for (const name in this.#defaults) {
                const prefValue =
                  prefs === null || prefs === void 0 ? void 0 : prefs[name];
      ...
      class GenericL10n {
        ...
        async get(key) {
          ...
          let fallback =
            arguments.length > 2 && arguments[2] !== undefined
              ? arguments[2]
              : (0, _l10n_utils.getL10nFallback)(key, args);
          const l10n = await this._ready;
        ...
        constructor(
          ...
          let optionalContentConfigPromise =
            arguments.length > 4 && arguments[4] !== undefined
              ? arguments[4]
              : null;
          let printAnnotationStoragePromise =
  ...
  (() => {
    ...
    (_document$blockUnbloc = (_document = document).blockUnblockOnload) ===
      null || _document$blockUnbloc === void 0
      ? void 0
      : _document$blockUnbloc.call(_document, true);
    if (
