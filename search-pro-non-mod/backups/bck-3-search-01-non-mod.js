...
// [1.2] Cross-window Communication Channel (BroadcastChannel API)
...
// [1.3] Method: Cleanup for Search Event Listeners
...
// [1.4] Shared Selection Index for Search Results
let selectedIndex = -1;
...
window.tourSearchFunctions = (function () {
  ...
  function _getThumbnailUrl(resultItem, config) {
    ...
    // Business/Sheets data takes priority (keep your existing logic)
    ...
    if (resultItem.type === "Panorama" && resultItem.item) {
      ...
      if (media) {
        ...
        if (thumb) {
          console.log(`Found tour thumbnail for ${resultItem.label}: ${thumb}`);
  ...
  function _applySearchStyling() {
    ...
    console.log("🔍 THUMBNAIL BORDER DEBUG - Configuration Values:");
    console.log(
      "  📝 Config borderRadius:",
      _config.thumbnailSettings?.borderRadius,
    );
    console.log(
      "  📝 Config borderColor:",
      _config.thumbnailSettings?.borderColor,
    );
    console.log(
      "  📝 Config borderWidth:",
      _config.thumbnailSettings?.borderWidth,
    );

    console.log("🔍 THUMBNAIL BORDER DEBUG - Processed Values:");
    console.log("  ✅ thumbnailRadius:", thumbnailRadius);
    console.log("  ✅ thumbnailBorderColor:", thumbnailBorderColor);
    console.log("  ✅ thumbnailBorderWidth:", thumbnailBorderWidth);

    console.log("🔍 THUMBNAIL BORDER DEBUG - CSS Variables Set:");
    console.log(
    ...
    // Check if CSS variables are actually being read by elements
    setTimeout(() => {
      const testElement = document.querySelector(".result-image");
      if (testElement) {
        const computedStyle = window.getComputedStyle(testElement);
        console.log(
          "🔍 THUMBNAIL BORDER DEBUG - Computed CSS on .result-image:",
        );
        ...
        console.log(
          "🔍 THUMBNAIL BORDER DEBUG - No .result-image elements found yet",
        );
      }
    }, 2000);

    // Debug logging
    console.log("🖼️ Thumbnail border settings applied:", {
      radius: thumbnailRadius + "px",
      color: thumbnailBorderColor,
      width: thumbnailBorderWidth + "px",
    });
  ...
  function _initializeSearch(tour) {
    ...
    const highlightMatch = (text, term) => {
      ...
      try {
        // [6.17.1] Sanitize the search term to prevent regex errors
    ...
    if (window.searchFunctions) {
      window.searchFunctions.updateConfig({
        ...
        thumbnailSettings: {
          ...
          // ==========================================
          // [10.4] Thumbnail appearance settings
        ...
        // [10.5] Element inclusion options
        includeContent: {
        ...
        // ==========================================
        // Customize how element types appear in search results (e.g., change "Panorama" to "Location")
        // ==========================================
        // [10.6] Display labels
        displayLabels: {
        ...
        // ==========================================
        // Customize the search interface Border Radius, Colors, and Tag appearance
        // ==========================================
        // [10.7]
        appearance: {
          searchField: {
          ...
          // [10.9] Logic Block: Add tag color customizations
          colors: {
            ...
            // [10.10] Logic Block: Add tag color customizations
          ...
          // [10.11] Logic Block: Add tag appearance settings
          tags: {
        ...
        // [10.12] Logic Block: Add search bar settings
        searchBar: {
        ...
        // [10.15] Apply display settings to search results
        display: {
        ...
        // ==========================================
        // [10.5] Element filtering options
        filter: {
        ...
        // ==========================================
        // BUSINESS DATA SUPPORT - You can use business data to replace tour labels (/business-data folder and business.json)
        // ==========================================
        businessData: {
        ...
        // [9.1.3.1] Logic Block: Google Sheets support
        // ==========================================
        ...
        */
        ...
        // ===================================
        // ADVANCED SETTINGS - SEARCH RANKING & BEHAVIOR SETTINGS
        // ===================================
        searchSettings: {
